export type WorldLaw = {
  ...
  countryCode: string;
  flag: string;
  region: "Asia-Pacific" | "Middle East" | "Europe & UK" | "Americas" | "Africa";
  lawName: string;
  acronym: string;
  enactedYear: number;
  status: "In Force" | "Active & Enforced" | "Draft Rules 2025" | "Amended";
  governingBody: string;
  officialPortal: string;
  maxPenalty: string;
  extraterritorialScope: boolean;
  dpoMandatory: boolean;
  breachNotificationHours: number | "Immediate" | "Reasonable time";
  childrenAgeThreshold: number | "N/A";
  crossBorderAdequacyRequired: boolean;
  ...
  standardDraftTemplate: string;
};

export const WORLD_LAWS_DATA: WorldLaw[] = [
  // 1. INDIA
  {
    id: "india-dpdp",
    country: "India",
    ...
    keyArticles: [
      {
        ...
        topic: "Notice",
        mandate:
          "Mandatory itemized notice specifying personal data categories, processing purpose, and GRO contact before obtaining consent.",
      },
      {
        number: "Section 6",
        topic: "Consent",
      ...
      },
      {
        ...
        topic: "Security",
        mandate:
          "Data Fiduciary must implement reasonable security safeguards to prevent personal data breaches.",
      },
      {
        number: "Section 8(6)",
        topic: "Breach Notification",
        mandate:
          "Mandatory statutory notification of breach to DPBI and each affected Data Principal.",
      },
      {
        number: "Section 9",
        topic: "Child Data",
        mandate:
          "Prohibits tracking, behavioral monitoring, or targeted ads directed at children under 18.",
      },
      {
        number: "Section 13",
        topic: "Grievance",
    ...
    statutorySummary:
      "India's comprehensive privacy law regulating digital personal data processing within India and extraterritorially when offering goods or services to Data Principals in India.",
    standardDraftTemplate:
      "Statutory Itemized Notice under Section 5 & Consent Protocol under Section 6 with DPBI appellate channel disclosures.",
  },
    ...
    keyArticles: [
      {
        ...
        topic: "Principles",
        mandate:
          "Fairness, transparency, purpose limitation, data minimization, accuracy, and storage limitation.",
      },
      {
        number: "Article 6",
        topic: "Consent",
      ...
      },
      {
        ...
        mandate:
          "Rights to access, cease processing, erasure, rectification, and data portability.",
      },
      {
        number: "Article 22-23",
        topic: "Cross-Border Transfers",
        mandate:
          "Transfers outside UAE only permitted to jurisdictions with adequate protection or under approved standard contractual clauses.",
      },
    ],
    statutorySummary:
      "Federal privacy law governing personal data processing in the UAE and foreign entities processing data of individuals residing in the UAE.",
    standardDraftTemplate:
      "Bilingual Arabic/English Sovereign Processing Notice & Standard Contractual Transfer Clauses pursuant to Articles 5, 6, 22 and 23.",
  },
    ...
    keyArticles: [
      {
        ...
        topic: "Legal Basis",
        mandate:
          "Consent, contractual necessity, legal obligation, vital interests, public interest, or legitimate interests.",
      },
      {
        number: "Article 28",
        topic: "Data Processor",
        mandate:
          "Binding DPA requiring documented instructions, confidentiality, sub-processor controls, and audit rights.",
      },
      {
        number: "Article 32",
        topic: "Security (TOMs)",
        mandate:
          "Implementation of TLS 1.3 encryption, pseudonymization, CSP headers, and regular penetration testing.",
      },
      {
        number: "Article 33",
        topic: "Breach Notification",
        mandate:
          "Notification to Lead DPA within 72 hours of becoming aware of a risk-bearing data breach.",
      },
      {
        number: "Chapter V",
        topic: "Transfers",
        mandate:
          "International data transfers governed by adequacy decisions, EU SCC Modules 1-4, or BCRs.",
      },
    ],
    statutorySummary:
      "The global gold standard data protection regulation governing personal data processing across all 27 EU Member States with extraterritorial reach worldwide.",
    standardDraftTemplate:
      "Article 28 Data Processing Addendum (DPA) with Standard Contractual Clauses (SCCs) and Article 32 TOMs Schedule.",
  },
  ...
  // 4. UNITED KINGDOM
  {
    ...
    keyArticles: [
      ...
      },
      {
        ...
        topic: "Cookies",
        mandate:
          "Explicit consent required before storing or accessing non-essential cookies or telemetry.",
      },
    ],
    statutorySummary:
      "Post-Brexit data protection framework mirroring EU GDPR with UK-specific International Data Transfer Agreements (IDTA) and ICO enforcement.",
    standardDraftTemplate:
      "UK International Data Transfer Addendum & Article 28 Compliance Addendum for UK data controllers.",
  },
  ...
  // 5. UNITED STATES - CALIFORNIA
  {
    ...
    maxPenalty:
      "Up to $7,500 per intentional violation; $100-$750 per consumer for breach statutory damages",
    extraterritorialScope: true,
    dpoMandatory: false,
    ...
    keyArticles: [
      {
        ...
        mandate:
          "Clear disclosure of categories collected, business purposes, and retention periods at or before collection.",
      },
      {
        number: "§ 1798.120",
      ...
      },
      {
        ...
        topic: "GPC Signal",
        mandate:
          "Mandatory frictionless recognition of browser Sec-GPC opt-out preference headers.",
      },
      {
        number: "§ 1798.140",
        topic: "Service Provider",
        mandate:
          "Contractual restrictions prohibiting retaining, using, or disclosing data outside business relationship.",
      },
    ],
    statutorySummary:
      "Pioneering comprehensive state privacy law in the United States establishing consumer rights and creating the first dedicated privacy agency (CPPA).",
    standardDraftTemplate:
      "CCPA/CPRA Notice at Collection, DNSMPI Opt-Out Schedule, and Service Provider Data Addendum.",
  },
  ...
  // 6. SINGAPORE
  {
    ...
    keyArticles: [
      ...
      },
      {
        ...
        topic: "Breach Notification",
        mandate:
          "Mandatory reporting to PDPC within 3 calendar days (72 hours) for notifiable breaches.",
      },
      {
        number: "Section 26",
        topic: "Transfer Limitation",
        mandate:
          "Recipient must provide comparable standard of protection under legally enforceable obligations.",
      },
    ],
    statutorySummary:
      "Singapore's foundational privacy statute governing commercial personal data processing across financial, tech, and healthcare sectors.",
    standardDraftTemplate:
      "Enterprise Statutory Compliance Instrument, DPO Designation Charter, and Part VIA Breach Protocol.",
  },
  ...
  // 7. BRAZIL
  {
    ...
    keyArticles: [
      ...
      },
      {
        ...
        topic: "Rights",
        mandate:
          "Guarantees data subject rights to confirmation, access, correction, anonymization, and deletion.",
      },
      {
        number: "Artigo 41",
      ...
      },
      {
        ...
        mandate:
          "Communication to ANPD and data subjects of security incidents that may create relevant risk.",
      },
    ],
    statutorySummary:
      "Brazil's comprehensive privacy law inspired by GDPR with extraterritorial jurisdiction over any processing offering goods or services to individuals in Brazil.",
    standardDraftTemplate:
      "Termo de Governança de Privacidade e Tratamento de Dados Pessoais conforme a Lei 13.709/2018.",
  },
  ...
  // 8. CANADA
  {
    ...
    region: "Americas",
    lawName:
      "Personal Information Protection and Electronic Documents Act (PIPEDA) & Consumer Privacy Protection Act (CPPA / Bill C-27)",
    acronym: "PIPEDA / C-27",
    enactedYear: 2000,
    status: "In Force",
    ...
    keyArticles: [
      ...
      },
      {
        ...
        mandate:
          "Mandatory report to Privacy Commissioner for breaches creating real risk of significant harm.",
      },
      {
        number: "Quebec Law 25",
        topic: "Privacy by Default",
        mandate:
          "Highest privacy default settings and mandatory Privacy Impact Assessments (PIAs).",
      },
    ],
    statutorySummary:
      "Canada's federal private-sector privacy legislation governing commercial data collection with modernized protections under Quebec Law 25 and Bill C-27.",
    standardDraftTemplate:
      "PIPEDA Schedule 1 Compliance Charter & Mandatory RROSH Breach Assessment Schedule.",
  },
  ...
  // 9. AUSTRALIA
  {
    ...
    region: "Asia-Pacific",
    lawName:
      "Privacy Act 1988 & Australian Privacy Principles (APPs) (Privacy and Other Legislation Amendment Act 2024)",
    ...
    keyArticles: [
      ...
      },
      {
        ...
        mandate:
          "Accountability for acts and practices of overseas recipients of personal information.",
      },
      {
        number: "Part IIIC",
        topic: "NDB Scheme",
        mandate:
          "Mandatory statement to OAIC and individuals for eligible data breaches likely to result in serious harm.",
      },
    ],
    statutorySummary:
      "Federal privacy law regulating Australian Government agencies and private sector organizations with annual turnover over AUD $3M and extraterritorial commercial links.",
    standardDraftTemplate:
      "Australian Privacy Principles (APP 1-13) Enterprise Policy & Part IIIC Notifiable Data Breach Schedule.",
  },
  ...
  // 10. JAPAN
  {
    ...
    region: "Asia-Pacific",
    lawName:
      "Act on the Protection of Personal Information (APPI - Act No. 57 of 2003, Amended 2020/2022)",
    acronym: "Japan APPI",
    enactedYear: 2003,
    status: "Amended",
    ...
    maxPenalty:
      "Up to ¥100,000,000 for corporations; criminal penalties for unauthorized provision",
    extraterritorialScope: true,
    dpoMandatory: false,
    breachNotificationHours: "Immediate",
    childrenAgeThreshold: 16,
    ...
    keyArticles: [
      ...
      },
      {
        ...
        mandate:
          "Take necessary and appropriate measures for prevention of leakage or loss of personal data.",
      },
      {
        number: "Article 24",
        topic: "Third-Party Transfer",
        mandate:
          "Prior consent required before providing personal data to third parties, especially overseas.",
      },
    ],
    statutorySummary:
      "Japan's landmark privacy legislation with mutual adequacy with the EU GDPR, strict governance over personal information handling, and strong individual rights.",
    standardDraftTemplate:
      "APPI Statutory Processing Declaration & Cross-Border Third-Party Provision Agreement.",
  },
    ...
    keyArticles: [
      {
        ...
        topic: "Consent",
        mandate:
          "Strict itemized consent requirement before collection, use, or provision to third parties.",
      },
      {
        number: "Article 29",
        topic: "Security Measures",
        mandate:
          "Implementation of technical, managerial, and physical security measures including encryption.",
      },
      {
        number: "Article 34",
        topic: "Breach Notification",
        mandate:
          "Immediate notification to data subjects and reporting to PIPC/KISA within 72 hours.",
      },
      {
        number: "Article 31",
        topic: "Chief Privacy Officer",
        mandate:
          "Mandatory CPO designation responsible for comprehensive personal information management.",
      },
    ],
    statutorySummary:
      "World-leading stringent data privacy legislation in South Korea with intense criminal liabilities, strict consent segregation, and mutual EU adequacy.",
    standardDraftTemplate:
      "PIPA Segregated Consent Architecture & Chief Privacy Officer Compliance Charter.",
  },
  ...
  // 12. SOUTH AFRICA
  {
    ...
    keyArticles: [
      {
        ...
        mandate:
          "Lawful, reasonable processing that does not infringe privacy and only with consent/justification.",
      },
      {
        number: "Section 19",
        topic: "Security Safeguards",
        mandate:
          "Secure integrity and confidentiality by taking appropriate, reasonable technical and organizational measures.",
      },
      {
        number: "Section 22",
        topic: "Breach Notification",
        mandate:
          "Notify the Information Regulator and data subjects as soon as reasonably possible after breach discovery.",
      },
      {
        number: "Section 55",
    ...
    statutorySummary:
      "Comprehensive data protection statute in Africa establishing stringent conditions for processing personal data belonging to both natural and juristic persons.",
    standardDraftTemplate:
      "POPIA 8-Condition Compliance Manual & Information Officer Statutory Charter.",
  },
  ...
  // 13. SAUDI ARABIA
  {
    ...
    region: "Middle East",
    lawName:
      "Personal Data Protection Law (Royal Decree No. M/19 of 1443H / Amended M/148 of 1444H)",
    acronym: "Saudi PDPL",
    enactedYear: 2021,
    status: "Active & Enforced",
    ...
    maxPenalty:
      "Up to SAR 5,000,000 in administrative fines; criminal penalties for sensitive data leaks",
    extraterritorialScope: true,
    dpoMandatory: true,
    breachNotificationHours: 72,
    childrenAgeThreshold: 18,
    ...
    keyArticles: [
      ...
      },
      {
        ...
        topic: "Breach Reporting",
        mandate:
          "Notify SDAIA within 72 hours of becoming aware of an incident causing harm to personal data.",
      },
      {
        number: "Article 29",
        topic: "Cross-Border Transfers",
    ...
    statutorySummary:
      "Saudi Arabia's landmark personal data law supervised by SDAIA, protecting individual privacy while supporting Vision 2030 digital economy initiatives.",
    standardDraftTemplate:
      "Sovereign Saudi PDPL Data Controller Charter & SDAIA Cross-Border Compliance Schedule.",
  },
  ...
  // 14. NIGERIA
  {
    ...
    maxPenalty:
      "Up to ₦10,000,000 or 2% of annual gross revenue (for Data Controllers of Major Importance)",
    extraterritorialScope: true,
    dpoMandatory: true,
    breachNotificationHours: 72,
    childrenAgeThreshold: 18,
    ...
    keyArticles: [
      ...
      },
      {
        ...
        topic: "Transfers",
        mandate:
          "International transfers permitted only under adequacy, standard contractual clauses, or valid consent.",
      },
    ],
    statutorySummary:
      "Africa's largest economy's comprehensive privacy law establishing the NDPC and introducing high-grade accountability for major data fiduciaries.",
    standardDraftTemplate:
      "NDPA 2023 Major Data Controller Compliance Framework & NDPC Statutory Notice.",
  },
];
